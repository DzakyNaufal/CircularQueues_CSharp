    ...
    class Queues
    {
        ...
        public void insert(int element)
        {
            ...
            /* The following statement checks whether the queue is empty. If the
             queue is empty, then value of the REAR and FRONT variables is set to 0.*/
            if (FRONT == -1)
            {
                FRONT = 0;
                REAR = 0;
            ...
            {
                /*If REAR is ar the last position of the array, then the value of 
            ...
            /* Once the position of REAR is determined, the elements is added at its proper place. */
        ...
        public void remove()
        {
            ...
            else
            {
                /*If the element to be deleted is at the last position of the array,
                 then the value of FRONT is set to 0 i.e to the first element of the array. */
                if (FRONT == max - 1)
                    FRONT = 0;
                else
